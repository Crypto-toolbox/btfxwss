...
class WebSocketConnection(Thread):
    ...
    def disconnect(self):
        """Disconnect from the websocket connection and join the Thread."""
    ...
    def _on_close(self, ws, *args):
        """Clear states and stop timers on closed websocket connection."""
        self.log.info("Connection closed")
        self.connected.clear()
        self._stop_timers()

    def _on_open(self, ws):
        """Set state and send ping, along with resubs, if required."""
    ...
    def _on_error(self, ws, error):
        """Set states for required reconnect and connection."""
    ...
    def send_ping(self):
        """Send a ping message to the API and start pong timers."""
    ...
    def pass_to_client(self, event, data, *args):
        """
        Pass data up to the client via a Queue().
    ...
    def _resubscribe(self, soft=False):
        """Resubscribe to all channels found in self.channel_configs.
